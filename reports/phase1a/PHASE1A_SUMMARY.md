...
> 查阅注记（2026-08-29）：本文原称“人工检查”的步骤没有独立审阅者身份记录，现按实际执行范围记为“AI 辅助视觉检查”，不代表独立人工或医学复核。其他指标与时间顺序未改。详见[结果解释与勘误](../../docs/RESULT_INTERPRETATION_NOTES.md)。
...
- B4 的四样本数值检查、坐标换算检查和 4 张叠加图 AI 辅助视觉检查；
...
B3 结构探针通过；B4 固定四样本跑满 500 步，eval MRE_ALL **4.6088 px**，4/4 AoP 有效，AI 辅助视觉检查未观察到明显坐标或通道错位。H1 监督参考完整跑完 20 轮，best 为第 3 轮：MRE_ALL **32.391 px**、AoP MAE **12.130°**；第 20 轮分别为 **39.642 px** 和 **23.109°**，best/last 都是 100/100 有效 AoP。独立只读复算的 best/last 保存指标最大差值为 0。
